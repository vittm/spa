            ...
            '.menu': {
                ...
                '.menu-container': {
                    ...
                    '.right-container': {
                        ...
                        '&:before': {
                            'border-bottom-width': 31 * scale,
                            'border-left-width': 40 * scale,
                        },
                        '.menu-wrapper': {
                            ...
                            '>ul': {
                                '>li': {
                                    ...
                                    '>a': {
                                        'font-size': 12 * scale,
                                        'padding-top': 21 * scale,
                                        'padding-bottom': 21 * scale,
                                    },
                                    '.icon-caret': {
                                        '&:before': {
                                            'bottom': 24 * scale,
                                            'right': -4 * scale,
                                            'border-width': 10 * scale,
                                        }
                                    },
                                    '.submenu': {
                                        '>ul': {
                                            ...
                                            '>li': {
                                                ...
                                                '.secondsub': {
                                                    ...
                                                    ul: {
                                                        ...
                                                        'border-bottom-left-radius': 25 * scale,
